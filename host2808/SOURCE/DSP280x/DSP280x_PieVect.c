...
interrupt void error_ISR(void)  // Empty ISR - only does a return.
{
	SciaRegs.SCITXBUF = 0xAA;
	SciaRegs.SCITXBUF = 0xAA;
	SciaRegs.SCITXBUF = PieCtrlRegs.PIEACK.all;
	SciaRegs.SCITXBUF = PieCtrlRegs.PIEACK.all>>8;
	SciaRegs.SCITXBUF = PieCtrlRegs.PIEIFR1.all;
	SciaRegs.SCITXBUF = PieCtrlRegs.PIEIFR1.all>>8;
	SciaRegs.SCITXBUF = PieCtrlRegs.PIEIER1.all;
	SciaRegs.SCITXBUF = PieCtrlRegs.PIEIER1.all>>8;
